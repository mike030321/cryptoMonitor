...
- run_id: `20260501T071904Z`
- coin/timeframe: `bitcoin/5m`
- lookback: `380.0 days` (holdout `14` days starting `2026-04-17T07:19:04.147819Z`)
...
- registry slot: `models/bitcoin/5m/20260501T071913Z` (version `20260501T071913Z`)
- manifest tags: calibration_method=`platt`, calibration_status=`trustworthy`, label_family=`C_post_cost`, abstain_tau=`0.7706099535257283`, friction_threshold_pct=`0.8`
