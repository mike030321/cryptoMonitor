# Auto failure-analysis — 2026-04-23T17:29:36.247522+00:00

- **Source report generated_at:** `2026-04-23T16:50:00.957824+00:00`
...
| Coin | Bucket | n_holdout | DA / baseline | Brier vs base | collapse_gap | top pred share | share near prior | contam | net PnL %/trade | reason |
|---|---|---|---|---|---|---|---|---|---|---|
| (pooled) | `structurally_noisy_retire` | 16452 | 0.363 / 0.405 | 0.228 / 0.214 | 0.363 | 0.751 | 0.134 | — | -0.265 (n=2211) | calibration_broken=True (max reliability deviation 0.908 >= 0.1); prediction_… |
| bonk | `structurally_noisy_retire` | 1744 | 0.386 / 0.405 | 0.256 / 0.213 | 0.476 | 0.865 | 0.000 | — | -0.194 (n=179) | calibration_broken=True (max reliability deviation 0.414 >= 0.1); prediction_… |
| celestia | `structurally_noisy_retire` | 1744 | 0.386 / 0.398 | 0.251 / 0.214 | 0.413 | 0.801 | 0.019 | — | -0.228 (n=401) | calibration_broken=True (max reliability deviation 0.111 >= 0.1); prediction_… |
| dogwifcoin | `structurally_noisy_retire` | 1744 | 0.396 / 0.404 | 0.254 / 0.214 | 0.463 | 0.861 | 0.104 | — | -0.215 (n=385) | calibration_broken=True (max reliability deviation 0.132 >= 0.1); prediction_… |
| floki-inu | `structurally_noisy_retire` | 1744 | 0.376 / 0.412 | 0.247 / 0.214 | 0.316 | 0.696 | 0.000 | — | -0.176 (n=34) | calibration_broken=True (max reliability deviation 0.734 >= 0.1); prediction_… |
| injective-protocol | `structurally_noisy_retire` | 1744 | 0.377 / 0.397 | 0.239 / 0.215 | 0.486 | 0.869 | 0.000 | — | -0.291 (n=429) | calibration_broken=True (max reliability deviation 0.615 >= 0.1); prediction_… |
| jupiter-exchange-solana | `salvageable_with_better_features_or_labels` | 1744 | 0.386 / 0.410 | 0.253 / 0.213 | 0.098 | 0.485 | 0.085 | — | -0.242 (n=393) | red gate but signal remaining — calibration_broken=True, prediction_collapse=… |
| pepe | `structurally_noisy_retire` | 1744 | 0.371 / 0.399 | 0.258 / 0.216 | 0.517 | 0.904 | 0.049 | — | -0.297 (n=572) | calibration_broken=True (max reliability deviation 0.298 >= 0.1); prediction_… |
| render-token | `structurally_noisy_retire` | 1744 | 0.374 / 0.401 | 0.257 / 0.214 | 0.329 | 0.724 | 0.225 | — | -0.235 (n=290) | calibration_broken=True (max reliability deviation 0.117 >= 0.1); prediction_… |
...
| worldcoin-wld | `structurally_noisy_retire` | 1744 | 0.386 / 0.401 | 0.263 / 0.215 | 0.419 | 0.826 | 0.607 | — | -0.288 (n=394) | calibration_broken=True (max reliability deviation 0.370 >= 0.1); prediction_… |

### 2h

| Coin | Bucket | n_holdout | DA / baseline | Brier vs base | collapse_gap | top pred share | share near prior | contam | net PnL %/trade | reason |
|---|---|---|---|---|---|---|---|---|---|---|
| (pooled) | `structurally_noisy_retire` | 8192 | 0.370 / 0.400 | 0.233 / 0.215 | 0.537 | 0.939 | 0.114 | — | -0.233 (n=1392) | calibration_broken=True (max reliability deviation 0.284 >= 0.1); prediction_… |
| bonk | `structurally_noisy_retire` | 869 | 0.383 / 0.412 | 0.262 / 0.214 | 0.402 | 0.799 | 0.000 | — | -0.233 (n=663) | calibration_broken=True (max reliability deviation 0.636 >= 0.1); prediction_… |
...
| dogwifcoin | `structurally_noisy_retire` | 869 | 0.388 / 0.404 | 0.288 / 0.215 | 0.528 | 0.955 | 0.043 | — | -0.259 (n=662) | calibration_broken=True (max reliability deviation 0.334 >= 0.1); prediction_… |
| floki-inu | `salvageable_with_better_features_or_labels` | 869 | 0.386 / 0.409 | 0.280 / 0.215 | 0.433 | 0.815 | 0.000 | — | -0.269 (n=342) | red gate but signal remaining — calibration_broken=False, prediction_collapse… |
...
| pepe | `structurally_noisy_retire` | 869 | 0.373 / 0.392 | 0.272 / 0.218 | 0.437 | 0.841 | 0.046 | — | -0.306 (n=580) | calibration_broken=True (max reliability deviation 0.416 >= 0.1); prediction_… |
